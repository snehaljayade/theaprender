...
<form class="pure-form pure-form-stacked">
    <table><th>
        <legend>Registration Form</legend></th>
		
			
			<div class="pure-g">	        
            <tr><div class="pure-u-1 pure-u-md-1-3">
                <td><label for="fname">First Name</label></td>
                <td><input value="<?php echo set_value('fname'); ?>" id="fname" name="fname" type="text"></td>
            </div></tr>

            <tr><div class="pure-u-1 pure-u-md-1-3">
                <td><label for="mname">Middle Name</label></td>
                <td><input value="<?php echo set_value('mname'); ?>" id="mname" name="mname" type="text"></td>
            </div></tr>

            <tr><div class="pure-u-1 pure-u-md-1-3">
                <td><label for="lname">Last Name</label></td>
                <td><input value="<?php echo set_value('lname'); ?>" id="lname" name="lname" type="text" ></td>
            </div></tr>
