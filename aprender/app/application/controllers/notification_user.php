<?php
class Notification_user_home extends CI_Controller {
 			function __construct()
		{
			...
			$this->template->write_view('navigation','theme/nav/usernav');
			$this->template->write_view('sidebar','theme/sidebar/usersidebar');
